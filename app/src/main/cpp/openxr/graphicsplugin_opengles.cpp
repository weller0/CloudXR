...
struct OpenGLESGraphicsPlugin : public IGraphicsPlugin {
    ...
    void InitializeDevice(XrInstance instance, XrSystemId systemId) override {
        ...
        Log::Write(Log::Level::Info,Fmt("ksGpuWindow_Create nativeWindow(%p)",window.nativeWindow));
        GLint major = 0;
        GLint minor = 0;
    ...
    void RenderView(const XrCompositionLayerProjectionView& layerView, const XrSwapchainImageBaseHeader* swapchainImage,
        ...
        Log::Write(Log::Level::Info,Fmt("xmh viewport(%d,%d,%d,%d)",layerView.subImage.imageRect.offset.x,layerView.subImage.imageRect.offset.y
        ...
        Log::Write(Log::Level::Info,Fmt("Render colorTexture(%u),depthTexture(%u)",colorTexture,depthTexture));
        ...
        XrMatrix4x4f proj;
        XrMatrix4x4f_CreateProjectionFov(&proj, GRAPHICS_OPENGL_ES, layerView.fov, 0.01f, 1000.0f);
        XrMatrix4x4f toView;
        XrVector3f scale{1.f, 1.f, 1.f};
        XrQuaternionf torotation{-pose.orientation.x,-pose.orientation.y,-pose.orientation.z,pose.orientation.w};
